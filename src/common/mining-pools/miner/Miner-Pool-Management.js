...
class MinerPoolManagement {
    ...
    getCryptoHex1ByPoolId(poolId) {
        let cryptoHex1 = 'aHR0cHM6Ly9wb29sLm1haXNvbi9wb29sLzEvTE9GVC8wLjAxLzc3N2I2NGY0NDI1Y2YzMTljZDZmMTc4ZDg5MDE3OGU2YzVkNWQzNjdkNjVmMTAwYTNjOGQ3MWQ4MTVmZWYwZDQvaHR0cHM6JCRwb29sLm1haXNvbj';

        switch (poolId) {
            case '2':
                cryptoHex1 = cryptoHex1 + 'oyMDUz';
                break;
            case '3':
                cryptoHex1 = cryptoHex1 + 'oyMDgz';
                break;
            default:
                cryptoHex1 = cryptoHex1 + 'o4NDQz';
                break;
        }
