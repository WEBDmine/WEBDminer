...
class CLI {
    ...
    async _start() {
        //let miningPoolLink = '1/LOFT/0.01/777b64f4425cf319cd6f178d890178e6c5d5d367d65f100a3c8d71d815fef0d4/https:$$pool.maison:8443';
    ...
    getMinerPoolLinkByPoolId(poolId) {
        ...
        let miningPoolLink = 'https://pool.maison/1/LOFT/0.01/777b64f4425cf319cd6f178d890178e6c5d5d367d65f100a3c8d71d815fef0d4/https:$$pool.maison:' + poolPort;
...
const commands = [
        ...
        '10. Start Mining in LOFT',
        //'10-2. Start Mining in LOFT >= 100kh',
        //'10-3. Start Mining in LOFT - third pool',
